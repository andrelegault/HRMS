    ...
    <div class="navigation-wrap">
      ...
      <div class="menu">
        <nav role="navigation" class="navigation-items w-nav-menu">
        	<a href="/root/add-employee.jsp" class="navigation-item w-nav-link">ADD EMPLOYEE</a>
        	<a href="/root/attendance.jsp" class="navigation-item w-nav-link">SEE ATTENDANCE</a>
        </nav>
